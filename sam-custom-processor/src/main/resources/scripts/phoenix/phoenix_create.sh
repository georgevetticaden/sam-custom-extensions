...
# Run the scripts
$psql_script <ZK_HOST>:2181:/hbase-unsecure ./sql/phoenix_create_drivers.sql data/drivers.csv
$psql_script <ZK_HOST>:2181:/hbase-unsecure ./sql/phoenix_create_timesheet.sql data/timesheet.csv
