 ...
 *
 */
public class FeatureNormalizationWithDelayProcessor implements CustomProcessorRuntime {


	private static final String CONFIG_DELAY_TIMEOUT_IN_SEC = "delayTimeOutSecs";	
	...
	protected static final Logger LOG = LoggerFactory.getLogger(FeatureNormalizationWithDelayProcessor.class);
